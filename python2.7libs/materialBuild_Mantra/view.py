...
class Ui_RSMatBuilder(object):
    def setupUi(self, RSMatBuilder):
        ...
        self.cbx_diffpt = QtWidgets.QCheckBox(RSMatBuilder)
        self.cbx_diffpt.setObjectName("cbx_diffpt")
        self.verticalLayout.addWidget(self.cbx_diffpt)
        self.cbx_diffPack = QtWidgets.QCheckBox(RSMatBuilder)
        self.cbx_diffPack.setObjectName("cbx_diffPack")
        self.verticalLayout.addWidget(self.cbx_diffPack)
        ...
        self.cbx_dispLinear = QtWidgets.QCheckBox(RSMatBuilder)
        self.cbx_dispLinear.setObjectName("cbx_dispLinear")
        self.verticalLayout.addWidget(self.cbx_dispLinear)
        self.cbx_bumpLinear = QtWidgets.QCheckBox(RSMatBuilder)
        self.cbx_bumpLinear.setObjectName("cbx_bumpLinear")
        self.verticalLayout.addWidget(self.cbx_bumpLinear)
    ...
    def retranslateUi(self, RSMatBuilder):
        ...
        self.cbx_diffpt.setText(_translate("RSMatBuilder", "Use Point Color for Diffuse"))
        self.cbx_diffPack.setText(_translate("RSMatBuilder", "Use Packed Color for Diffuse"))
